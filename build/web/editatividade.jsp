    ...
    <div class="modal-dialog" role="document">
        ...
        <div id="main" class="container-fluid">
            ...
            <form action="atividade" method="post">
                ...
                <input type="hidden" value="${atividade.atividade_Codigo}"  name="codigo" >
                <div class="col-lg-offset-3">
                <div class="form-group col-lg-4 ">
                    <label for="nome">Nome</label>
                    <input type="text" id="nome" value="${atividade.atividade_Nome}"  name="nome" class="form-control" required="">
                </div>
                <div class="form-group col-lg-11 "></div>
                <div class="form-group col-lg-4 ">
                    <label for="descricao">Descri&ccedil;&atilde;o</label>
                    <input type="text" id="nivel" name="descricao" class="form-control" required="" value="${atividade.atividade_Descricao}">
                </div>
                <div class="form-group col-lg-11 "></div>
                <div class="form-group col-lg-4 ">
                    ...
                    <select name="nivel" class="form-control">
                       <c:forEach var="nivel" items="${nc.pesquisar_nivel('')}" >     
                           <c:choose>
                                <c:when test="${atividade.nivel_Codigo == nivel.nivel_Codigo}">
                            ...
                            <option ${selecao} value="${nivel.nivel_Codigo}" >${nivel.nivel_Descricao}</option>  
                        </c:forEach>
                    </select>
                </div>
                <div class="form-group col-lg-11 "></div>     
