...
<div class="modal fade" id="delete-modal" tabindex="-1" role="dialog" aria-labelledby="modalLabel">
    <div class="modal-dialog" role="document">
        ...
        <div id="main" class="container-fluid">
            <center><h1>Alterar Bairro</h1></center>
            <form action="bairro" method="post">
                <input type="hidden" value="E" name="acao"/>
                <input type="hidden" value="${bairro.bairro_Codigo}" name="id"/>
                <div class="col-lg-offset-3">
                <div class="form-group col-lg-6 ">
                    <label for="bairro">Bairro</label>
                    <input type="text" id="bairro" name="bairro" class="form-control" value="${bairro.bairro_Descricao}" required="">
                </div>
                <hr>
