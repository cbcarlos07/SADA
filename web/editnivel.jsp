...
<div class="modal fade" id="delete-modal" tabindex="-1" role="dialog" aria-labelledby="modalLabel">
    <div class="modal-dialog" role="document">
        ...
        <div id="main" class="container-fluid">
            <center><h1>Alterar Nivel</h1></center>
            <form action="nivel" method="post">
                <input type="hidden" value="E" name="acao"/>
                <input type="hidden" value="${nivel.nivel_Codigo}" name="id"/>
                <div class="col-lg-offset-3">
                <div class="form-group col-lg-6 ">
                    <label for="nivel">Bairro</label>
                    <input type="text" id="nivel" name="nivel" class="form-control" value="${nivel.nivel_Descricao}" required="">
                </div>
                <hr>
